...
| _see all newrelic ext options_          | -             | [8.x newrelic] | [7.x newrelic] |
...
| _see all sqlsrv ext options_            | -             | -              | [7.x sqlsrv]   |
| _see all session options_               | [8.1 session] | [8.0 session]  | [7.4 session]  |
| `PHP_XHPROF`                            |               |                |                |
| _see all xhprof options_                | [8.x xhprof]  | [8.x xhprof]   | [7.x xhprof]   |
| [`PHP_UPLOAD_MAX_FILESIZE`]             | `32M`         | `32M`          | `32M`          |
| [`PHP_XDEBUG`]                          |               |                |                |
| [`PHP_XDEBUG_MODE`]                     | `off`         | `off`          | `off`          |
| _see all xdebug ext options_            | [8.x xdebug]  | [8.x xdebug]   | [7.x xdebug]   |
...
You can run Crond with this image changing the command
to `sudo -E LD_PRELOAD=/usr/lib/preloadable_libiconv.so crond -f -d 0` and mounting a crontab file
