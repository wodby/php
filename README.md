...
| PHP_APCU_ENABLE                       | 1                   | >=7.0     |
| PHP_APCU_SHM_SEGMENTS                 | 1                   | >=7.0     |
| PHP_APCU_SHM_SIZE                     | 32M                 | >=7.0     |
| PHP_APCU_ENTRIES_HINT                 | 4096                | >=7.0     |
| PHP_APCU_TTL                          | 0                   | >=7.0     |
| PHP_APCU_GC_TTL                       | 3600                | >=7.0     |
| PHP_APCU_SLAM_DEFENSE                 | 1                   | >=7.0     |
| PHP_APCU_ENABLE_CLI                   | 0                   | >=7.0     |
| PHP_APCU_USE_REQUEST_TIME             | 1                   | >=7.0     |
| PHP_APCU_SERIALIZER                   | default             | >=7.0     |
| PHP_APCU_RFC1867                      | 0                   | >=7.0     |
| PHP_APCU_RFC1867_PREFIX               | upload_             | >=7.0     |
| PHP_APCU_RFC1867_NAME                 | APC_UPLOAD_PROGRESS | >=7.0     |
| PHP_APCU_RFC1867_FREQ                 | 0                   | >=7.0     |
| PHP_APCU_RFC1867_TTL                  | 3600                | >=7.0     |
| PHP_APCU_COREDUMP_UNMAP               | 0                   | >=7.0     |
| PHP_APCU_PRELOAD_PATH                 | NULL                |           |
...
> - ">=5.6" – Env var available on for PHP versions starting from 5.6
> - "FPM" – This setting is set only for PHP-FPM
> - "FPM 5.3" - This setting is set only for PHP-FPM with PHP 5.3
